...
<script type="text/javascript">
	...
	function doQuery() {
			...
			var isCheckC = $('#showNoScore').prop('checked');
			if(isCheckC){
				queryParams.showNoScore = '1';
			}else{
				queryParams.showNoScore = '';
			}
	...
	function clearSearch() {	 
			$('#teacherid').val(''); 
			$('#showNoScore').prop('checked',false);
			var queryParams = $('#dataListDiv').datagrid('options').queryParams;
	...
	<form  id="searchform" name="searchform" method="post">		
		<table class="datagrid-body" width="100%">
			<tr>
							...
							<td class="datagrid-header">未评价教师信息：</td>
							<td><input type="checkbox" id="showNoScore" name="showNoScore" value="0" /> </td> 
			</tr>
			<tr>
