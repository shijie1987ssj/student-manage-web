				...
				<form id="saveForm" name="saveForm" method="post"
					...
					<table class="searchTable" cellspacing="1" cellpadding="5" align="center">
						<tr> 
							...
							<td width="20%"> 
                                <input name="gradename" id="gradename" value="" class="easyui-textbox easyui-validatebox" 
								missingMessage="请输入年级" invalidMessage="最多不超过字符" validType="idlenth" required="true"/>
							</td>
						</tr>
					</table>
				</form>
