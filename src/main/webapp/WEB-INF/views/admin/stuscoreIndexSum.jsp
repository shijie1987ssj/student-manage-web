...
<script type="text/javascript">
	var listUrl = '${ctx}/stuscore/stuscoreListDataSum.do'; 
	$(function(){
			$('#dataListDiv').datagrid({
				...
				columns:[[
							...
							{field:'stuclub',title:'系部',align : 'center',width:50}, 
							{field:'stuclass',title:'班级',align : 'center',width:50}, 
							...
							{field:'pass',title:'240分以上',align : 'center',width:50}, 
							{field:'nopass',title:'240分以下',align : 'center',width:50}, 
							{field:'gradec',title:'240~300分人数',align : 'center',width:50}, 
							{field:'gradeb',title:'300分~340分人数',align : 'center',width:50}, 
							{field:'gradea',title:'340~400分人数',align : 'center',width:50}
				]]
			});
		});
	function reload(){
