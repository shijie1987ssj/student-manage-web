...
<script  type="text/javascript">
	//保存方法
	function save() {
		add_url = '${ctx}/classInfo/classInfoAdd.do';
		/*******************设置form参数********************************/
				...
				<form id="saveForm" name="saveForm" method="post"
					...
					<table class="searchTable" cellspacing="1" cellpadding="5" align="center">
						<tr> 
							...
							<td width="20%"> 
                                <input name="classname" id="classname" value="" class="easyui-textbox easyui-validatebox" 
								missingMessage="请输入班级名称" invalidMessage="最多不超过字符" validType="idlenth" required="true"/>
							</td>
						</tr>
					</table>
				</form>
